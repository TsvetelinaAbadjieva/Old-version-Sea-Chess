        ...
        <div class="">
            ...
            <aside class="asside col-md-3 col-xs-5 col-sm-5 border">
                <div class="" >
                    ...
                    <div>
                        <button  id="results" type="button" class="button button2 col-xs-3 col-sm-3" style="width:250px; height:38px; font-size:12px; float:right; padding-bottom:5px;">Show results</button>
                    ...
                    <div class="pagination">
                        <form action="game.php" method="get">
                            <nav aria-label="...">
                                <ul class="pager">
                                    <li class="previous"><a<?php ($active_page<=1) ? $page=$active_page : $page=$active_page-1;$active_page=$active_page-1; ?> href="<?php  echo $url.'?page='.$page; ?>"><span aria-hidden="true" id="pager">&larr;</span> Older</a></li>
                                    <li class="next"><a <?php ($active_page == $total_pages) ? $page=$total_pages: $page=$active_page+1; $active_page=$active_page+1; ?> href="<?php  echo $url.'?page='.$page; ?>">Newer <span aria-hidden="true" id="pager">&rarr;</span></a></li>
                                </ul>
                            </nav>
                        </form>
                    </div>
                ...
                <div class="loadData">
                    ...
                    <table class="table table-condensed table-bordered" hidden id="table2">
...
/*        $(document).ready(function (){
   ...
   /*
                $.ajax({
                    url:'http://mylocal.dev/MyPHP_files/seachess/php/loadResults.php',
                    type:'GET',
                    data:{},
                    dataType: 'json',
                    cache: false,
